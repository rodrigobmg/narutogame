...
class Securimage {
	...
	var $ssid = "securimage_code_value";
  /**
  ...
  function saveData()
  {
    $_SESSION[$this->ssid] = strtolower($this->code);
  }
  ...
  function validate()
  {
    if ( isset($_SESSION[$this->ssid]) && !empty($_SESSION[$this->ssid]) ) {
      if ( $_SESSION[$this->ssid] == strtolower(trim($this->code_entered)) ) {

...
this.evercookie_cache = function(name, value)
{
	if (typeof(value) != "undefined")
	{
		...
		img.src = __ec_site + 'action/evercookie_cache.php?name=' + name;
	}
	else
	{
		// interestingly enough, we want to erase our evercookie
		// http cookie so the php will force a cached response
		var origvalue = this.getFromStr('evercookie_cache' + name, document.cookie);
		self._ec.cacheData = undefined;
		document.cookie = 'evercookie_cache' + name + '=; expires=Mon, 20 Sep 2010 00:00:00 UTC; path=/';

		$.ajax({
			url: __ec_site + 'action/evercookie_cache.php?name=' + name,
			success: function(data) {
				// put our cookie back
				document.cookie = 'evercookie_cache' + name + '=' + origvalue + '; expires=Tue, 31 Dec 2030 00:00:00 UTC; path=/';
...
this.evercookie_etag = function(name, value)
{
	if (typeof(value) != "undefined")
	{
		...
		img.style.visibility = 'hidden';
		img.style.position = 'absolute';
		img.src = __ec_site + 'action/evercookie_etag.php?name=' + name;
	}
	else
	{
		// interestingly enough, we want to erase our evercookie
		// http cookie so the php will force a cached response
		var origvalue = this.getFromStr('evercookie_etag' + name, document.cookie);
		self._ec.etagData = undefined;
		document.cookie = 'evercookie_etag=; expires=Mon, 20 Sep 2010 00:00:00 UTC; path=/';

		$.ajax({
			url: __ec_site + 'action/evercookie_etag.php?name=' + name,
			success: function(data) {
				// put our cookie back
				document.cookie = 'evercookie_etag_' + name + '=' + origvalue + '; expires=Tue, 31 Dec 2030 00:00:00 UTC; path=/';
...
this.evercookie_lso = function(name, value)
{
	...
	swfobject.embedSWF("images/evercookie.swf", "swfcontainer", "1", "1", "9.0.0", false, flashvars, params, attributes);
}
...
this.evercookie_png = function(name, value)
{
	if (document.createElement('canvas').getContext)
	{
		if (typeof(value) != "undefined")
		{
			...
			img.style.visibility = 'hidden';
			img.style.position = 'absolute';
			img.src = __ec_site + 'action/evercookie_png.php?name=' + name;
		}
		else
		{
			...
			// interestingly enough, we want to erase our evercookie
			// http cookie so the php will force a cached response
			var origvalue = this.getFromStr('evercookie_png' + name, document.cookie);
			...
			{
				// put our cookie back
				document.cookie = 'evercookie_png' + name + '=' + origvalue + '; expires=Tue, 31 Dec 2030 00:00:00 UTC; path=/';
...
this.evercookie_silverlight = function(name, value) {
    ...
    */
        var source = "images/evercookie.xap";

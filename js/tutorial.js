  ...
  Tour = (function() {
    function Tour(options) {
      ...
      this._options = $.extend({
        ...
        delay: false,
        basePath: '',
        template: '<div class="popover" style="background-color: #FFF; width: 325px;" role="tooltip"> <div class="arrow arrow2"></div> <h3 class="popover-title" style="background-color: #FFF; color: #000"></h3> <div class="popover-content" style="background-color: #FFF; color: #000; padding: 9px 14px;"></div> <div class="popover-navigation"> <div class="btn-group" align="center"> <button class="btn btn-sm btn-default" data-role="prev">&laquo; Anterior</button> <button class="btn btn-sm btn-default" data-role="next">Próximo &raquo;</button><button class="btn btn-sm btn-default" data-role="end" data-tutorial="1" style="margin-top:5px">Conheço essa página e quero encerrar o tutorial!</button> <button class="btn btn-sm btn-default" data-role="pause-resume" data-pause-text="Pause" data-resume-text="Resume">Pause</button> </div></div></div>',

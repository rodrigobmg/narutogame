...
<table width="730" border="0" cellpadding="0" cellspacing="0">
	<tr class="cor_sim">
		...
		<td width="303" align="left"><img src="<?php echo img()?>layout/icones/ene.png" width="24" height="24" /> * 8</td>
	</tr>
	<tr class="cor_nao">
		...
		<td align="left" class="cor_nao"><img src="<?php echo img()?>layout/icones/ene.png" width="24" height="24" /> * 8 +  ( <img src="<?php echo img()?>layout/icones/nin.png" width="24" height="24" /> ) * <?php echo $basePlayer->id_classe_tipo==2 ? 12 : 6 ?> + ( <img src="<?php echo img()?>layout/icones/gen.png" width="24" height="24" /> ) * <?php echo $basePlayer->id_classe_tipo==3 ? 12 : 6 ?></td>
	</tr>
	<tr class="cor_sim">
		...
		<td align="left" class="cor_sim"><img src="<?php echo img()?>layout/icones/ene.png" width="24" height="24" /> * 8  + ( <img src="<?php echo img()?>layout/icones/tai.png" width="24" height="24" /> ) * <?php echo $basePlayer->id_classe_tipo==1 ? 12 : 6 ?> + ( <img src="<?php echo img()?>layout/icones/ken.png" width="24" /> ) * <?php echo $basePlayer->id_classe_tipo==4 ? 12 : 6 ?>  </td>
	</tr>
	<tr class="cor_sim">
		...
		<td align="left" class="cor_nao">( <img src="<?php echo img()?>layout/icones/forc.png" width="24" height="24" /> / 2 ) + ( <img src="<?php echo img()?>layout/icones/tai.png" width="24" height="24" />  ) / <?php echo $basePlayer->id_classe_tipo==1 ? 6 : 12 ?> + (  <img src="<?php echo img()?>layout/icones/ken.png" width="24" /> ) / <?php echo $basePlayer->id_classe_tipo==4 ? 6 : 12 ?></td>
	</tr>
	<tr class="cor_sim">
		...
		<td align="left" class="cor_sim">( <img src="<?php echo img()?>layout/icones/inte.png" width="24" height="24" /> / 2 ) + ( <img src="<?php echo img()?>layout/icones/nin.png" width="24" height="24" /> ) / <?php echo $basePlayer->id_classe_tipo==2 ? 6 : 12 ?> + (  <img src="<?php echo img()?>layout/icones/gen.png" width="24" height="24" />) / <?php echo $basePlayer->id_classe_tipo==3 ? 6 : 12 ?></td>
	</tr>
	<tr class="cor_sim">
		...
		<td align="left" class="cor_nao">( <img src="<?php echo img()?>layout/icones/defense.png" width="24" height="24" /> / 2 ) + (  <img src="<?php echo img()?>layout/icones/nin.png" width="24" height="24" /> ) / <?php echo $basePlayer->id_classe_tipo==2 ? 6 : 12 ?> + (  <img src="<?php echo img()?>layout/icones/gen.png" width="24" height="24" />) / <?php echo $basePlayer->id_classe_tipo==3 ? 6 : 12 ?></td>
	</tr>
	<tr class="cor_sim">
		...
		<td align="left" class="cor_sim">( <img src="<?php echo img()?>layout/icones/defense.png" width="24" height="24" /> / 2 ) + ( <img src="<?php echo img()?>layout/icones/tai.png" width="24" height="24" />  ) / <?php echo $basePlayer->id_classe_tipo==1 ? 6 : 12 ?> + ( <img src="<?php echo img()?>layout/icones/ken.png" width="24" /> ) / <?php echo $basePlayer->id_classe_tipo==4 ? 6 : 12 ?></td>
	</tr>
	<tr class="cor_sim">
		<td align="center" class="cor_nao"><img src="<?php echo img()?>layout/icones/prec_nin_gen.png" /></td>
		<td height="35" align="left" class="cor_nao">Precisão ( Nin / Gen)</td>
		<td align="left" class="cor_nao">+1 de Precisão ( Nin / Gen)</td>
		<td align="left" class="cor_nao"><img src="<?php echo img()?>layout/icones/conhe.png" /> * 1</td>
	</tr>
	<tr class="cor_sim">
		<td align="center" class="cor_sim"><img src="<?php echo img()?>layout/icones/prec_tai.png" /></td>
		<td height="35" align="left" class="cor_sim">Precisão ( Tai / Buk)</td>
		<td align="left" class="cor_sim">+1 de Precisão ( Tai / Buk)</td>
		<td align="left" class="cor_sim"><img src="<?php echo img()?>layout/icones/agi.png" /> * 1</td>
	</tr>
	<tr class="cor_sim">
		...
		<td align="left" class="cor_nao">1% <?php echo t('atributos.a15');?></td>
		<td align="left" class="cor_nao">( <img src="<?php echo img()?>layout/icones/esquiva.png" />  ) / 5</td>
	</tr>
	<tr class="cor_sim">
		...
		<td align="left" class="cor_sim">1% <?php echo t('atributos.a14');?> <?php echo t('atributos.a16');?></td>
		<td align="left" class="cor_sim">( <img src="<?php echo img()?>layout/icones/target2.png" /> ) / 5</td>
	</tr>
	<tr class="cor_sim">
		...
		<td align="left" class="cor_nao">1% <?php echo t('atributos.a14');?> <?php echo t('formula.conv');?></td>
		<td align="left" class="cor_nao">( <img src="<?php echo img()?>layout/icones/convic.png" /> ) / 5<br /></td>
	</tr>
	<tr class="cor_sim">
		<td align="center" class="cor_sim"><img src="<?php echo img()?>layout/icones/deter.png" alt="" width="24" height="24" /></td>
		<td height="35" align="left" class="cor_sim"><?php echo t('formula.det');?></td>
		<td align="left" class="cor_sim">1% <?php echo t('atributos.a14');?> <?php echo t('formula.det');?></td>
		<td align="left" class="cor_sim">( <img src="<?php echo img()?>layout/icones/deter.png" /> ) / 5  </td>
	</tr>
	<tr class="cor_sim">
		<td align="center" class="cor_nao"><img src="<?php echo img()?>layout/icones/esquiva.png" alt="" width="24" height="24" /></td>
		...
		<td align="left" class="cor_nao">( <img src="<?php echo img()?>layout/icones/esquiva.png" /> ) / 6 + ( <img src="<?php echo img()?>layout/icones/agi.png" width="24" height="24" /> + <img src="<?php echo img()?>layout/icones/conhe.png" width="24" height="24" /> ) / 6 + ( <?php echo t('atributos.a19');?> / 6 )</td>
	</tr>
	<tr class="cor_sim">
		<td align="center" class="cor_sim"><img src="<?php echo img()?>layout/icones/target2.png" alt="" width="24" height="24" /></td>
		...
		<td align="left" class="cor_sim">( <img src="<?php echo img()?>layout/icones/target2.png" /> ) / 6 + ( <img src="<?php echo img()?>layout/icones/agi.png" width="24" height="24" /> + <img src="<?php echo img()?>layout/icones/conhe.png" width="24" height="24" /> ) / 6 + ( <?php echo t('atributos.a19');?> / 6 )</td>
	</tr>
  <tr class="cor_sim">
...
<table width="730" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr class="cor_sim">
  	...
  	<td align="left" class="cor_nao">( <?php echo t('atributos.a43');?> * -15 )</td>
  	</tr>
  <tr class="cor_sim">
  	<td align="center" class="cor_sim" ><b style="font-size:13px; " class="amarelo">-15</b></td>
  	<td height="35" align="left" class="cor_sim"><?php echo t('atributos.a251');?></td>
  	<td align="left" class="cor_sim">( <?php echo t('atributos.a431');?> * -15 )</td>
  	</tr>
  <tr class="cor_sim">
  	<td align="center" class="cor_nao"><b style="font-size:13px; " class="amarelo">-5</b></td>
  	<td height="35" align="left" class="cor_nao"><?php echo t('atributos.a26');?></td>
  	<td align="left" class="cor_nao">( <?php echo t('atributos.a44');?> * -5 )</td>
  	</tr>
  <tr class="cor_sim">
  ...
  <tr class="cor_nao">
  	...
  	<td align="left" class="cor_nao">( <?php echo t('atributos.a57');?> * 2000 )</td>
  	</tr>
</table>
<br />
<table width="730" border="0" cellpadding="0" cellspacing="0">

...
?>
<?php if(!$basePlayer->tutorial()->bijuus){?>
<script>
...
$(function () {
    var tour = new Tour({
	  ...
	  {
		element: ".msg_gai",
		title: "<?php echo t("tutorial.titulos.bijuus.1");?>",
		content: "<?php echo t("tutorial.mensagens.bijuus.1");?>",
		placement: "top"
	  }
	]});
	//Renicia o Tour
...
<div class="titulo-secao"><p><?php echo t('bijuus.b1')?></p></div>
<?php msg('1',''.t('bijuus.b2').'', ''.t('bijuus.b3').'');?>
<br/>
...
<table width="730" border="0" align="left" cellpadding="4" cellspacing="0" class="claObj" id="tbCla_<?php echo encode(isset($rCla['id'])); ?>">
	...
	?>
	<tr <?php echo $bg ?>>
	  <td  width="510"><img src="<?php echo img() ?>layout<?php echo LAYOUT_TEMPLATE?>/bijuus/<?php echo $rItem['id'] ?>.jpg" /></td>

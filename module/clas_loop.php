...
<tr <?php echo $bg ?>>
	<td width="90"  align="center">
		<div class="img-lateral-dojo2">
			<img src="<?php echo img('layout/clas/'. $cla['id'].'/'.$i->getAttribute('ordem').'.png')?>" width="53" height="53" style="margin-top:5px"/>
		</div>	
	</td>
	...
	<td width="273" height="34" align="center" class="bonus-text">
		...
		<?php if($i->esquiva): ?>
		<p>
		<strong class="verde" style="font-size:13px">% <?php echo $i->esquiva ?></strong> <img src="<?php echo img('layout/icones/esquiva2.png') ?>" /><br /><?php echo t('formula.esquiva')?> 
		</p>
		<?php endif; ?>
	...
	<td width="92" align="center">
		...
		<form method="post" action="?acao=cla_treinar">

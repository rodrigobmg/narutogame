...
?>
<div class="titulo-secao"><p><?php echo t('halldafama.h17')?> - Round 10</p></div>
<div class="msg_gai" >
	<div class="msg">
	  ...
	  <tr <?php echo $cor ?> id="t-detalhe-player-<?php echo $r['id_equipe'] ?>" style="display: none">
		<td colspan="7">
			<div id="d-detalhe-player-<?php echo $r['id_equipe'] ?>" style="display: block"><br />
				...
				<?php 
				$qMembros = Recordset::query("SELECT nome, level, id_graduacao, score, id_classe,id_vila FROM historico_ninja WHERE id_player in (".$r['id_players'].") AND round=10");

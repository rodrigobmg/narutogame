...
?>
<div class="titulo-secao"><p><?php echo t('halldafama.h17')?> - Round 29</p></div>
<div class="msg_gai" >
	<div class="msg">
		<div class="msg_text" style="background:url(<?php echo img() ?>layout/msg/<?php echo $village = $_SESSION['basePlayer'] ? $basePlayer->id_vila : rand(1, 8);?>/1.png); background-repeat: no-repeat;">
			<b><?php echo t('halldafama.h17')?>,</b>
			<p>
			<?php echo t('halldafama.h2')?>
			<br /><br />
			<div style="float:left; margin-left:20px">
			<a href="?secao=halldafama_equipe_r10" class="linkTopo"><?php echo t('halldafama.h17')?> <?php echo t('halldafama.h4')?> Round 10</a><br />
			<a href="?secao=halldafama_equipe_r11" class="linkTopo"><?php echo t('halldafama.h17')?> <?php echo t('halldafama.h4')?> Round 11</a><br />
			<a href="?secao=halldafama_equipe_r12" class="linkTopo"><?php echo t('halldafama.h17')?> <?php echo t('halldafama.h4')?> Round 12</a><br />
			<?php echo t('halldafama.h17')?> <?php echo t('halldafama.h4')?> Round 13<br />
			<a href="?secao=halldafama_equipe_r14" class="linkTopo"><?php echo t('halldafama.h17')?> <?php echo t('halldafama.h4')?> Round 14</a><br />
			<a href="?secao=halldafama_equipe_r15" class="linkTopo"><?php echo t('halldafama.h17')?> <?php echo t('halldafama.h4')?> Round 15</a><br />
            <a href="?secao=halldafama_equipe_r16" class="linkTopo"><?php echo t('halldafama.h17')?> <?php echo t('halldafama.h4')?> Round 16</a><br />
            <a href="?secao=halldafama_equipe_r17" class="linkTopo"><?php echo t('halldafama.h17')?> <?php echo t('halldafama.h4')?> Round 17</a><br />
            <a href="?secao=halldafama_equipe_r18" class="linkTopo"><?php echo t('halldafama.h17')?> <?php echo t('halldafama.h4')?> Round 18</a><br />
            <a href="?secao=halldafama_equipe_r19" class="linkTopo"><?php echo t('halldafama.h17')?> <?php echo t('halldafama.h4')?> Round 19</a><br />
            <a href="?secao=halldafama_equipe_r20" class="linkTopo"><?php echo t('halldafama.h17')?> <?php echo t('halldafama.h4')?> Round 20</a><br />
            <a href="?secao=halldafama_equipe_r21" class="linkTopo"><?php echo t('halldafama.h17')?> <?php echo t('halldafama.h4')?> Round 21</a><br />
            <a href="?secao=halldafama_equipe_r22" class="linkTopo"><?php echo t('halldafama.h17')?> <?php echo t('halldafama.h4')?> Round 22</a><br />
            <a href="?secao=halldafama_equipe_r23" class="linkTopo"><?php echo t('halldafama.h17')?> <?php echo t('halldafama.h4')?> Round 23</a><br />
            <a href="?secao=halldafama_equipe_r24" class="linkTopo"><?php echo t('halldafama.h17')?> <?php echo t('halldafama.h4')?> Round 24</a><br />
            <a href="?secao=halldafama_equipe_r25" class="linkTopo"><?php echo t('halldafama.h17')?> <?php echo t('halldafama.h4')?> Round 25</a><br />
            <a href="?secao=halldafama_equipe_r26" class="linkTopo"><?php echo t('halldafama.h17')?> <?php echo t('halldafama.h4')?> Round 26</a>
            <br />
            <a href="?secao=halldafama_equipe_r27" class="linkTopo"><?php echo t('halldafama.h17')?> <?php echo t('halldafama.h4')?> Round 27</a>
            <br />
            <a href="?secao=halldafama_equipe_r28" class="linkTopo"><?php echo t('halldafama.h17')?> <?php echo t('halldafama.h4')?> Round 28</a>
            <a href="?secao=halldafama_equipe_r29" class="linkTopo"><?php echo t('halldafama.h17')?> <?php echo t('halldafama.h4')?> Round 29</a>
...
<table width="730" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr <?php echo $cor ?>>
        ...
        <td width="170" height="34" align="left" nowrap="nowrap">
      		<b class="linkTopo <?php echo $posRanking ?>" style="font-size: 13px; <?php echo $posRanking2 ?>"><?php echo $r['nome_equipe'] ?></b>
	   </td>
        <td width="70" align="center"><p><?php echo $r['level_equipe'] == 26 ? 25: $r['level_equipe'] ?></p></td>
        <td width="70" align="center"><p><?php echo $r['score_equipe'] ?></p></td>
        <td width="70" align="center"><img src="<?php echo img() ?>layout/bandanas/<?php echo $r['id_vila'] ?>.png" width="48" height="24" /></td>
		<td width="125" align="center"><a id="<?php echo $r['id_equipe'] ?>" class="button b-detalhe"><?php echo t('botoes.detalhes')?></a></td>

      </tr>
	  <tr height="4"></tr>
	  <tr <?php echo $cor ?> id="t-detalhe-player-<?php echo $r['id_equipe'] ?>" style="display: none">
		<td colspan="7">
			<div id="d-detalhe-player-<?php echo $r['id_equipe'] ?>" style="display: block"><br />
				<b style="font-size:13px;" class="verde">Membros da Equipe</b><br /><br />
				<?php 

...
?>
<div class="titulo-secao"><p><?php echo t('halldafama.h18')?> - Round 19</p></div>
<div class="msg_gai" >
	<div class="msg">
		<div class="msg_text" style="background:url(<?php echo img() ?>layout/msg/<?php echo $village = $_SESSION['basePlayer'] ? $basePlayer->id_vila : rand(1, 8);?>/1.png); background-repeat: no-repeat;">
            ...
            <a href="?secao=halldafama_guild_r21" class="linkTopo"><?php echo t('halldafama.h18')?> do Round 22</a><br />

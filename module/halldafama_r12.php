...
?>
<div class="titulo-secao"><p><?php echo t('halldafama.h1')?> - Round 12</p></div>
<div class="msg_gai" >
	<div class="msg">
...
<table width="730" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td height="49" align="left" colspan="2" class="subtitulo-home"><b style="color:#fff; ">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo t('halldafama.h5')?> ( Round 12 )</b></td>
          </tr>
          <tr class="cor_nao">

...
?>
<div class="titulo-secao"><p><?php echo t('halldafama.h1')?> - Round 29</p></div>
<div class="msg_gai" >
	<div class="msg">
		<div class="msg_text" style="background:url(<?php echo img() ?>layout/msg/<?php echo $village = $_SESSION['basePlayer'] ? $basePlayer->id_vila : rand(1, 8);?>/1.png); background-repeat: no-repeat;">
            ...
            <a href="?secao=halldafama_r28" class="linkTopo">Round 28</a><br />
            <a href="?secao=halldafama_r29" class="linkTopo">Round 29</a><br />
            </div>
			</div>
			</p>
			<br><br>
...
<table width="730" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td height="49" align="left" colspan="2" class="subtitulo-home"><b style="color:#fff; ">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo t('halldafama.h5')?> ( Round 29 )</b></td>
          </tr>
          <tr class="cor_nao">

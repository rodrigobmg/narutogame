...
?>
<div class="titulo-secao"><p><?php echo t('titulos.rank_conquistas'); ?></p></div>
<br />
    ...
    <table width="730" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr >
		...
		?>
      	...
      	<td  align="right"><input type="submit" role="button" class="button" value="<?php echo t('geral.filtrar')?>" /></td>
      	</tr>
    </table>
<br />
<table width="730" border="0" cellpadding="0" cellspacing="0">

 ...
 * oauth_client.php
 *
 * @(#) $Id: oauth_client.php,v 1.52 2013/03/15 07:26:40 mlemos Exp $
 *
 */
...
<class>
	...
	<version>@(#) $Id: oauth_client.php,v 1.52 2013/03/15 07:26:40 mlemos Exp $</version>
...
*/
	...
	var $oauth_user_agent = 'PHP-OAuth-API (http://www.phpclasses.org/oauth-api $Revision: 1.52 $)';
	...
	{
		$redirect_url = (($this->offline && strlen($this->offline_dialog_url)) ? $this->offline_dialog_url : $this->dialog_url);
